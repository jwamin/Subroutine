...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        configureCell(cell, withRoutine: routine)
        return cell
    }
    ...
    var fetchedResultsController: NSFetchedResultsController<Routine> {
    ...
    var _fetchedResultsController: NSFetchedResultsController<Routine>? = nil
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                configureCell(tableView.cellForRow(at: indexPath!)!, withRoutine: anObject as! Routine)
            case .move:
                configureCell(tableView.cellForRow(at: indexPath!)!, withRoutine: anObject as! Routine)
